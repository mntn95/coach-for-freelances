    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <ScrollReveal animatesInView={false}>
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">{bookingData.expectations.subtitle}</p>
        </div>
      </ScrollReveal>

      <div className="space-y-6">
        {bookingData.expectations.items.map((item, index) => (
          <ScrollReveal animatesInView={false} key={index} delay={index * 0.1}>
