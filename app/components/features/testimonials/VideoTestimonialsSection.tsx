...
const VideoTestimonialsContent = lazy(() => import('./VideoTestimonialsContent'));
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <ScrollReveal>
        <div className="text-center mb-16">
          <h2 className="text-gray-900 mb-4">{testimonialsPageData.videoTestimonials.title}</h2>
        ...
        fallback={
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonialsPageData.videoTestimonials.videos.map((_, index) => (
              <ScrollReveal key={`video-skeleton-${index}`} delay={index * 0.1}>
