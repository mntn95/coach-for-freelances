...
export const bookingData: BookingData = {
  hero: {
    ...
    subtitle: 'Choisissez un créneau qui vous convient pour notre premier échange'
  },
  info: {
    items: [
      {
  ...
  calendly: {
    ...
    placeholder: {
      ...
      description: 'Remplacez "YOUR_CALENDLY_USERNAME" dans le code par votre nom d\'utilisateur Calendly pour activer le widget de réservation.',
