...
import { StatItem, TestimonialBase } from '@/types/common/shared';
...
export const testimonialsPageData: TestimonialsPageData = {
  hero: {
    title: 'Témoignages',
    subtitle: 'Des freelances IT comme vous qui ont doublé leurs revenus et retrouvé leur liberté',
  },
  stats: [
  ...
  successStories: {
    ...
    subtitle: 'Découvrez en détail comment certains de mes clients ont transformé leur activité',
    stories: [
      {
        name: 'Thomas Dubois',
