...
import { IconItem, CTAData, TestimonialBase } from '@/types/common/shared';
...
export const workshopsPageData: WorkshopsPageData = {
  hero: {
    ...
    subtitle: 'Des workshops pratiques en petits groupes pour développer vos compétences business',
  },
  benefits: [
    {
      icon: '🎯',
  ...
  workshops: {
    ...
    subtitle: 'Des sessions pratiques pour progresser rapidement sur un sujet précis',
  },
  included: {
