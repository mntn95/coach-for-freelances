...
import { LucideIcon, Target, TrendingUp, Zap, Users, Calendar, MessageCircle } from 'lucide-react';
...
export const servicesPageData: ServicesPageData = {
  hero: {
    title: 'Mes Services',
    subtitle: 'Des accompagnements sur mesure pour chaque étape de votre parcours freelance',
  },
  services: {
