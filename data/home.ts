...
export const homeData: HomeData = {
  hero: {
    ...
    description: 'Vous êtes développeur, DevOps ou consultant IT ? Vous tournez autour de 5k€/mois mais vous savez que vous valez plus ? Je vous aide à débloquer votre potentiel et à doubler vos revenus.',
  ...
  problems: {
    ...
    subtitle: 'La plupart des freelances IT sont techniquement excellents, mais bloqués sur le business',
    items: [
      {
        icon: '😰',
  ...
  cta: {
    ...
    description: 'Réservez votre appel découverte gratuit de 45 minutes. Aucun engagement, juste une conversation honnête sur vos objectifs.',
