...
export const aboutData: AboutData = {
  hero: {
    ...
    subtitle: 'De développeuse bloquée à 4k€/mois à coach pour freelances IT qui veulent leur liberté'
  },
  story: {
    title: 'Mon histoire',
    paragraphs: [
    ...
    quote: 'Votre valeur n\'est pas déterminée par vos compétences techniques, mais par l\'impact que vous créez pour vos clients.'
  },
  values: {
    title: 'Mes valeurs',
  ...
  expertise: {
    title: 'Mon expertise',
    description: 'Je ne suis pas coach généraliste. Je me spécialise uniquement dans l\'accompagnement de freelances IT (développeurs, DevOps, consultants cloud, data engineers...) qui veulent passer un cap financier et retrouver leur liberté.',
    skills: [
